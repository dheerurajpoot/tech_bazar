...
const testimonials = [
	{
		...
		content:
			"WebDeelers made selling my e-commerce site a breeze. The platform's user-friendly interface and secure transaction process gave me peace of mind throughout the sale.",
	},
	{
		name: "Nitya Sharma",
		role: "Digital Entrepreneur",
		content:
			"I've bought and sold multiple digital assets on WebDeelers. The variety of listings and the detailed analytics provided for each asset are unmatched. It's my go-to platform for online business transactions.",
	},
	{
		name: "Amit Kumar",
		role: "YouTube Content Creator",
		content:
			"When I decided to sell my YouTube channel, WebDeelers connected me with serious buyers quickly. The bidding system helped me get the best value for my years of hard work.",
	},
	{
		name: "Tanu Rajpoot",
		role: "Social Media Influencer",
		content:
			"WebDeelers's valuation tools helped me understand the true worth of my Instagram account. The seamless transaction process made selling my account a smooth experience.",
	},
	{
		name: "Sandeep Kumar",
		role: "App Developer",
		content:
			"As a developer, I appreciate the technical due diligence WebDeelers facilitates. It's the perfect place to showcase and sell my apps to a targeted audience of tech-savvy buyers.",
	},
];
