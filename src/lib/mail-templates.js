...
<body>
  <h3>
    Received a New order on ${process.env.COMPANY_NAME}
  </h3>
  <p>
    You have recieved a new order, check this order and proceed it as soon as possible.</p> 
</body>
...
<body>
  ...
  <p>
    Your product have been sold, we are processing this order, ready to transfer the asset.</p> 
</body>
                     ...
                     <td valign="top" class="pc-w620-padding-0-0-0-0" align="center">
                      <div class="pc-font-alt" style="text-decoration: none;">
                       <div style="font-size: 14px;line-height: 143%;text-align:center;text-align-last:center;color:#ffffff;letter-spacing:-0.2px;font-weight:400;font-style:normal;font-variant-ligatures:normal;">
                        <div><span style="font-family: 'Poppins', Arial, Helvetica, sans-serif; font-size: 14px; line-height: 143%; text-decoration: none; text-transform: none;">Bamba Road, Kalynapur kanpur (208017)</span>
                        </div>
                       </div>
                      </div>
                     </td>
